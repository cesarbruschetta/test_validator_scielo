"""
Django settings for validator_scielo project.
...
SECRET_KEY = 'ir&&0hc=75kv**9=^ih&@#ew)a_t0$l!yv%-mgqdm#we(#(t*$'
...
ROOT_URLCONF = 'validator_scielo.urls'
...
WSGI_APPLICATION = 'validator_scielo.wsgi.application'
